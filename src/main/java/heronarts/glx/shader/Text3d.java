...
public class Text3d extends ShaderProgram {
  ...
  protected void setUniforms(View view) {
    ...
    this.uniformTextMetrics.set(this.textSize, this.textScale.ordinal(), view.getAspectRatio(), this.glx.windowEngine.getUIZoom() * 2f / view.getHeight() * this.glx.windowEngine.mainWindow.getSystemContentScaleY());
